...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.reply'
        db.add_column(u'moderate_question', 'reply',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.reply'
        db.delete_column(u'moderate_question', 'reply')
    ...
    models = {
        ...
        u'moderate.question': {
            ...
            'reply': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        u'moderate.vote': {
