...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vote', fields ['user', 'question']
        db.create_unique(u'moderate_vote', ['user_id', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['user', 'question']
        db.delete_unique(u'moderate_vote', ['user_id', 'question_id'])
