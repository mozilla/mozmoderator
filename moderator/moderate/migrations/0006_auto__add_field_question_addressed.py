...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.addressed'
        db.add_column(u'moderate_question', 'addressed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.addressed'
        db.delete_column(u'moderate_question', 'addressed')
